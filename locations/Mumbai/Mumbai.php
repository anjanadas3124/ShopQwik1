...
<div class="container py-5">
    ...
    <div class="mall-selector" style="margin-top: 70px;">
        <select id="mallSelect" class="form-select" onchange="goToSlide(this.value)">
            ...
            <?php
            $malls = [
                ["name" => "Phoenix Marketcity", "image" => "https://www.phoenixoffices.in/wp-content/uploads/2015/12/DeathtoStock_Holiday2-1-1170x530.jpg", 'link' => '/PROJECTT/anj/ShopQwik-main/ShopQwik/locations/Delhi/citywalk.php', 'description' => 'Mumbai\'s largest mall with luxury shopping, entertainment, and dining options.', 'features' => ['Luxury', 'Entertainment', 'Dining']],
                ["name" => "High Street Phoenix", "image" => "https://www.hindustantimes.com/ht-img/img/2024/08/31/550x309/Mumbai--India--Aug-31--2024--Phoenix-Mill-compound_1725131803346.jpg", 'link' => '/PROJECTT/anj/ShopQwik-main/ShopQwik/locations/Delhi/citywalk.php', 'description' => 'Premium shopping destination with international brands and fine dining.', 'features' => ['International Brands', 'Fine Dining']],
                ["name" => "R City Mall", "image" => "https://assets-news.housing.com/news/wp-content/uploads/2023/02/24194631/R-City-Mall-in-Mumbai-Shopping-dining-and-entertainment-options-01.jpg", 'link' => '/PROJECTT/anj/ShopQwik-main/ShopQwik/locations/Delhi/citywalk.php', 'description' => 'Great for family outings with multiplex cinema and diverse food options.', 'features' => ['Family', 'Cinema', 'Food Court']],
                ["name" => "Infiniti Mall", "image" => "https://files.lbb.in/media/2019/12/5e05fd7da99fe673cd1d7792_1577450877774.jpg", 'link' => '/PROJECTT/anj/ShopQwik-main/ShopQwik/locations/Delhi/citywalk.php', 'description' => 'Great mix of brands, entertainment, and dining options for all ages.', 'features' => ['Fashion', 'Entertainment', 'Dining']],
                ["name" => "Oberoi Mall", "image" => "https://sceneloc8.com/wp-content/uploads/2024/03/Oberoi-Mall.png", 'link' => '/PROJECTT/anj/ShopQwik-main/ShopQwik/locations/Delhi/citywalk.php', 'description' => 'Conveniently located with great variety of stores and eateries.', 'features' => ['Convenient', 'Variety', 'Dining']],
                ["name" => "Nexus seawoods", "image" => "https://media.assettype.com/freepressjournal/2025-01-22/omzd0o3d/FotoJet-40.jpg?width=1200", 'link' => '/PROJECTT/anj/ShopQwik-main/ShopQwik/locations/Delhi/citywalk.php', 'description' => 'Modern mall with premium and local stores, plus entertainment options.', 'features' => ['Modern', 'Local Stores', 'Entertainment']]
            ];
