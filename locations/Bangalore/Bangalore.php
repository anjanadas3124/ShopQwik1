    ...
    <div class="mall-selector">
        <select id="mallSelect" class="form-select" onchange="goToSlide(this.value)">
            ...
            $malls = [
                ...
                ["name" => "Garuda Mall", "image" => "https://i.pinimg.com/736x/85/3d/37/853d37a47a2c591ba62e62021cb75042.jpg", 'link' => '/PROJECTT/anj/ShopQwik-main/ShopQwik/locations/Delhi/citywalk.php', 'description' => 'Delhi\'s iconic mall with diverse retail and entertainment spots.', 'features' => ['Retail', 'Entertainment']],
